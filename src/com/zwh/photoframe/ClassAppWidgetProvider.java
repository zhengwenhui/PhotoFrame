...
public class ClassAppWidgetProvider extends AppWidgetProvider {

	public static String ACTION_APPWIDGET_ONCLICK = "android.appwidget.action.APPWIDGET_CLASS_ONCLICK";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (ACTION_APPWIDGET_ONCLICK.equals(action)) {
			...
			if( length > 0 ){
				...
				mRemoteViews = new RemoteViews(context.getPackageName(), R.layout.photo_frame_class);
