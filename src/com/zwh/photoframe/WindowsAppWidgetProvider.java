...
public class WindowsAppWidgetProvider extends AppWidgetProvider {

	public static String ACTION_APPWIDGET_ONCLICK = "android.appwidget.action.APPWIDGET_WINDOWS_ONCLICK";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (ACTION_APPWIDGET_ONCLICK.equals(action)) {
			...
			if( length > 0 ){
				...
				mRemoteViews = new RemoteViews(context.getPackageName(), R.layout.photo_frame_windows);
				FileUtils fileUtils = new FileUtils();
				String avatarUri = fileUtils.getSDPATH()+WindowActivity.AVATAR_FILE_NAME;
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		...
		Intent intentClick = new Intent(context, WindowActivity.class);
